...
[Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2022/blob/main/R/solutions/ex1.r)
...
# For Windows
Path <- "C:/Users/Administrator/Documents/Github/intro-to-coding-2022/data/"

# For Mac
Path <- "/Users/Administrator/Documents/Github/intro-to-coding-2022/data/"
``` 
...
```{r Adding RowNames Argument, eval=TRUE,include=TRUE, message=FALSE, warning=FALSE, error=FALSE}
  setwd(Path)
  df <- read.csv(file = "r_data.csv",
                 row.names = 1)
  head(df)
...
```{r Ran on the Same Line, eval=TRUE,include=TRUE, message=FALSE, warning=FALSE, error=FALSE}
  setwd(Path)
...
```{r Adding stringsAsFactors, eval=TRUE,include=TRUE, message=FALSE, warning=FALSE, error=FALSE}
  setwd(Path)
  df <- read.csv(file = "r_data.csv", 
                 row.names = 1,
...
[Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2022/blob/main/R/solutions/ex2.r)
...
[Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2022/blob/main/R/solutions/ex3.r)
...
[Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2022/blob/main/R/solutions/ex4.r)
...
[Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2022/blob/main/R/solutions/ex5.r)
...
[Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2022/blob/main/R/solutions/ex6.r)
...
[Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2022/blob/main/R/solutions/ex7.r)
...
```{r Exercise 08 - hidden, eval=T, include = F, warning=F}
...
[Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2022/blob/main/R/solutions/ex8.r)
...
**QUESTION**: 
Does the interaction of sex and sleep qualiy predict gray matter volume?
